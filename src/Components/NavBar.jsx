...
const NavBar = () => {
  ...
  return (
    <div className={bg ? 'nav-head nav-head-changed bg-[#00000085] ease-in-out  backdrop-blur-[10px] border-b-[.5px] border-[#ffffff49] text-[#ffffffad] fixed w-[100%] z-[1000] ' : 'nav-head  bg-[#010206] text-[#ffffffad] ease-in-out  fixed w-[100%] z-[1000] '}>
