  ...
  return (
    ...
    <div className=" py-40 flex items-center justify-center flex-wrap ">
      {data.projects.map((project, idx) => (
        ...
        >
          <div className="group border-b-2 border-white h-[22rem] max-md:h-[40rem] w-full rounded-[15px] relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30  ">
            <div className="h-[22rem] max-md:h-[40rem] w-fit">
              <img
